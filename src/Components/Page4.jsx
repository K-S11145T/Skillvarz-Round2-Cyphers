      ...
      <div className="flex flex-row w-full h-full">
        ...
        <div className="w-[40%] h-[70%] p-5 ml-auto relative z-10">
          <div className="flex flex-col gap-10 mt-15 justify-center h-full">
            ...
            <div className="animate-float-slow -ml-[10%]" style={{ animationDelay: "0.2s" }}>
              <img 
                src="Page4/MarshallBlack-Logo.png" 
                alt="Marshal"
                width="190"
                className="w-auto h-auto"
              />
            </div>
            <div className="animate-float-slow -ml-[10%]" style={{ animationDelay: "0.7s" }}>
              <img 
                src="public/page4/marshallLogo 5.png" 
                alt="Marshal"
                width="190"
                className="w-auto h-auto"
              />
            </div>
            <div className="animate-float-slow -ml-[10%]" style={{ animationDelay: "1.2s" }}>
              <img 
                src="public/page4/marshallLogo 5.png" 
                alt="Marshal"
                width="190"
